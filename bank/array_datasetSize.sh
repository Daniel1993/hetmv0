...
function doRunLargeDTST {
	...
	do
		# 100M 500M 1G 1.5G
		timeout 40s ./bank -n $CPU_THREADS -b 1024 -x 128 -a 10000    -d $DURATION  -R 0 -S 16 -l 100 -N 1 -T 32 CPU_BACKOFF=40
		timeout 40s ./bank -n $CPU_THREADS -b 1024 -x 128 -a 100000   -d $DURATION  -R 0 -S 16 -l 100 -N 1 -T 32 CPU_BACKOFF=40
		timeout 40s ./bank -n $CPU_THREADS -b 1024 -x 128 -a 500000   -d $DURATION  -R 0 -S 16 -l 100 -N 1 -T 32 CPU_BACKOFF=40
		timeout 40s ./bank -n $CPU_THREADS -b 1024 -x 128 -a 2000000  -d $DURATION  -R 0 -S 16 -l 100 -N 1 -T 32 CPU_BACKOFF=40
		timeout 40s ./bank -n $CPU_THREADS -b 1024 -x 128 -a 5000000  -d $DURATION  -R 0 -S 16 -l 100 -N 1 -T 32 CPU_BACKOFF=40
		timeout 40s ./bank -n $CPU_THREADS -b 1024 -x 128 -a 15000000 -d $DURATION  -R 0 -S 16 -l 100 -N 1 -T 32 CPU_BACKOFF=40
		timeout 40s ./bank -n $CPU_THREADS -b 1024 -x 128 -a 25000000 -d $DURATION  -R 0 -S 16 -l 100 -N 1 -T 32 CPU_BACKOFF=40
		timeout 40s ./bank -n $CPU_THREADS -b 1024 -x 128 -a 65000000 -d $DURATION  -R 0 -S 16 -l 100 -N 1 -T 32 CPU_BACKOFF=40
		timeout 40s ./bank -n $CPU_THREADS -b 1024 -x 128 -a 125000000 -d $DURATION -R 0 -S 16 -l 100 -N 1 -T 32 CPU_BACKOFF=40
		# timeout 40s ./bank -n $CPU_THREADS -b 1024 -x 128 -a 250000000 -d $DURATION -R 0 -S 16 -l 90 -N 1 -T 32 CPU_BACKOFF=40
		timeout 40s ./bank -n $CPU_THREADS -b 1024 -x 128 -a 375000000 -d $DURATION -R 0 -S 16 -l 100 -N 1 -T 32 CPU_BACKOFF=40
		mv Bank.csv ${1}${s}
	done
}
...
make clean ; make CMP_TYPE=DISABLED USE_TSX_IMPL=1 CPUEn=0 PR_MAX_RWSET_SIZE=20 \
	BANK_PART=6 GPU_PART=0.55 CPU_PART=0.55 P_INTERSECT=0.00 PROFILE=1 -j 14 >/dev/null
