...
function doRunLargeDTST {
	...
	do
		timeout 30s ./bank -n $CPU_THREADS -b 1024 -x 512 -a $LARGE_DATASET -d $DURATION -R 0 -S 16 -l 15 -N 1 -T 2 -G $GPU_INPUT -C $CPU_INPUT
		# timeout 30s ./bank -n $CPU_THREADS -b 1024 -x 512 -a $LARGE_DATASET -d $DURATION -R 0 -S 2 -l 10 -N 1 -T 4 -G $GPU_INPUT -C $CPU_INPUT
		...
		timeout 30s ./bank -n $CPU_THREADS -b 1024 -x 512 -a $LARGE_DATASET -d $DURATION -R 0 -S 16 -l 95 -N 1 -T 2 -G $GPU_INPUT -C $CPU_INPUT
		mv Bank.csv ${1}${s}
	done
}
