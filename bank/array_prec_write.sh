...
function doRunLargeDTST {
	...
	for s in `seq 4 $SAMPLES`
	do
		# -n $CPU_THREADS -b 1024 -x 512 ---> changed to single threaded
		timeout 40s ./bank -n 1 -b 1 -x 1 -a $LARGE_DATASET -d $DURATION -R 0 -S 4 -l 10 -N 1 -T 32 CPU_BACKOFF=50
		timeout 40s ./bank -n 1 -b 1 -x 1 -a $LARGE_DATASET -d $DURATION -R 0 -S 4 -l 25 -N 1 -T 32 CPU_BACKOFF=50
		timeout 40s ./bank -n 1 -b 1 -x 1 -a $LARGE_DATASET -d $DURATION -R 0 -S 4 -l 50 -N 1 -T 32 CPU_BACKOFF=50
		timeout 40s ./bank -n 1 -b 1 -x 1 -a $LARGE_DATASET -d $DURATION -R 0 -S 4 -l 75 -N 1 -T 32 CPU_BACKOFF=50
		timeout 40s ./bank -n 1 -b 1 -x 1 -a $LARGE_DATASET -d $DURATION -R 0 -S 4 -l 90 -N 1 -T 32 CPU_BACKOFF=50
		mv Bank.csv ${1}${s}
	done
}
