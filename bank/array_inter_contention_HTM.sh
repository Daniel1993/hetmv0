...
function doRunLargeDTST_GPUonly {
	...
	do
		...
		timeout 30s ./bank -n $CPU_THREADS -b 1024 -x 512 -a $DATASET -d $DURATION -R 0 -S 16 -l 10 -N 1 -T 32 -f File10 CPU_BACKOFF=50
		timeout 30s ./bank -n $CPU_THREADS -b 1024 -x 512 -a $DATASET -d $DURATION -R 0 -S 16 -l 90 -N 1 -T 32 -f File90 CPU_BACKOFF=50
