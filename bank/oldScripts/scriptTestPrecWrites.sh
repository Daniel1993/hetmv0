...
function doRunSmallDTSTLowLocality {
	timeout 12s ./bank -n $CPU_THREADS -b 1024 -x 512 -a $SMALL_DATASET -d $DURATION -R 0 -S 8 -l 0   -N 1 -T 8
	timeout 12s ./bank -n $CPU_THREADS -b 1024 -x 512 -a $SMALL_DATASET -d $DURATION -R 0 -S 8 -l 10  -N 1 -T 8
	timeout 12s ./bank -n $CPU_THREADS -b 1024 -x 512 -a $SMALL_DATASET -d $DURATION -R 0 -S 8 -l 25  -N 1 -T 8
	timeout 12s ./bank -n $CPU_THREADS -b 1024 -x 512 -a $SMALL_DATASET -d $DURATION -R 0 -S 8 -l 50  -N 1 -T 8
	timeout 12s ./bank -n $CPU_THREADS -b 1024 -x 512 -a $SMALL_DATASET -d $DURATION -R 0 -S 8 -l 75  -N 1 -T 8
	timeout 12s ./bank -n $CPU_THREADS -b 1024 -x 512 -a $SMALL_DATASET -d $DURATION -R 0 -S 8 -l 90  -N 1 -T 8
	timeout 12s ./bank -n $CPU_THREADS -b 1024 -x 512 -a $SMALL_DATASET -d $DURATION -R 0 -S 8 -l 100 -N 1 -T 8
}
...
function doRunLargeDTSTLowLocality {
	timeout 12s ./bank -n $CPU_THREADS -b 1024 -x 512 -a $LARGE_DATASET -d $DURATION -R 0 -S 8 -l 0   -N 4 -T 8
	timeout 12s ./bank -n $CPU_THREADS -b 1024 -x 512 -a $LARGE_DATASET -d $DURATION -R 0 -S 8 -l 10  -N 4 -T 8
	timeout 12s ./bank -n $CPU_THREADS -b 1024 -x 512 -a $LARGE_DATASET -d $DURATION -R 0 -S 8 -l 25  -N 4 -T 8
	timeout 12s ./bank -n $CPU_THREADS -b 1024 -x 512 -a $LARGE_DATASET -d $DURATION -R 0 -S 8 -l 50  -N 4 -T 8
	timeout 12s ./bank -n $CPU_THREADS -b 1024 -x 512 -a $LARGE_DATASET -d $DURATION -R 0 -S 8 -l 75  -N 4 -T 8
	timeout 12s ./bank -n $CPU_THREADS -b 1024 -x 512 -a $LARGE_DATASET -d $DURATION -R 0 -S 8 -l 90  -N 4 -T 8
	timeout 12s ./bank -n $CPU_THREADS -b 1024 -x 512 -a $LARGE_DATASET -d $DURATION -R 0 -S 8 -l 100 -N 4 -T 8
}
...
# do
# 	doRunSmallDTSTLowLocality
# 	mv Bank.csv GPUonly_small_DISABLED_LL_s${s}
# 	doRunSmallDTSTHighLocality
# 	mv Bank.csv GPUonly_small_DISABLED_HL_s${s}
# 	doRunLargeDTSTLowLocality
# 	mv Bank.csv GPUonly_large_DISABLED_LL_s${s}
# 	doRunLargeDTSTHighLocality
# 	mv Bank.csv GPUonly_large_DISABLED_HL_s${s}
# done
...
do
	doRunSmallDTSTLowLocality
	mv Bank.csv GPUonly_small_DISABLED_URLL_s${s}
	doRunLargeDTSTLowLocality
	mv Bank.csv GPUonly_large_DISABLED_URLL_s${s}
done
...
make clean ; make LOG_TYPE=VERS USE_TSX_IMPL=1 INST_CPU=1 GPUEn=0 PR_MAX_RWSET_SIZE=20 BANK_PART=2 PROFILE=1 -j 14
for s in `seq $SAMPLES`
do
	doRunSmallDTSTLowLocality
...
make clean ; make LOG_TYPE=BMAP USE_TSX_IMPL=1 INST_CPU=1 GPUEn=0 PR_MAX_RWSET_SIZE=20 BANK_PART=2 PROFILE=1 -j 14
for s in `seq $SAMPLES`
do
	doRunSmallDTSTLowLocality
...
make clean ; make CMP_TYPE=COMPRESSED LOG_TYPE=VERS USE_TSX_IMPL=1 PR_MAX_RWSET_SIZE=20 BANK_PART=2 PROFILE=1 -j 14
for s in `seq $SAMPLES`
do
	doRunSmallDTSTLowLocality
...
make clean ; make CMP_TYPE=COMPRESSED LOG_TYPE=BMAP BANK_PART=2 PR_MAX_RWSET_SIZE=20 USE_TSX_IMPL=1 PROFILE=1 -j 14
for s in `seq $SAMPLES`
do
	doRunSmallDTSTLowLocality
