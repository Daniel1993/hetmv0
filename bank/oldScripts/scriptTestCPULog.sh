...
### ADDR W LOG
# make clean ; make LOG_TYPE=ADDR BANK_PART=2 GPUEn=0 INST_CPU=1 DISABLE_CHUNKS=1 -j 14
...
### ADDR W LOG
# make clean ; make LOG_TYPE=ADDR GPU_PART=$GPU_PART CPU_PART=$CPU_PART \
# 	P_INTERSECT=$P_INTERSECT BANK_PART=2 GPUEn=0 INST_CPU=1 USE_TSX_IMPL=1 DISABLE_CHUNKS=1 -j 14
