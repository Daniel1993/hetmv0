...
CPU_THREADS=4
# LOW_CPU_THREADS=2
LARGE_HIGH_CPU_THREADS=40
LARGE_VERY_HIGH_CPU_THREADS=50
SMALL_HIGH_CPU_THREADS=40
...
function doRunSmallDTST {
	timeout 12s ./bank -n $CPU_THREADS -b 1024 -x 512 -a $SMALL_DATASET -d $DURATION -T 8 -R 100 -S 1
	timeout 12s ./bank -n $CPU_THREADS -b 1024 -x 512 -a $SMALL_DATASET -d $DURATION -T 8 -R 100 -S 2
	timeout 12s ./bank -n $CPU_THREADS -b 1024 -x 512 -a $SMALL_DATASET -d $DURATION -T 8 -R 100 -S 4
	timeout 12s ./bank -n $CPU_THREADS -b 1024 -x 512 -a $SMALL_DATASET -d $DURATION -T 8 -R 100 -S 6
	timeout 12s ./bank -n $CPU_THREADS -b 1024 -x 512 -a $SMALL_DATASET -d $DURATION -T 8 -R 100 -S 8
	timeout 12s ./bank -n $CPU_THREADS -b 1024 -x 512 -a $SMALL_DATASET -d $DURATION -T 8 -R 100 -S 12
	timeout 12s ./bank -n $CPU_THREADS -b 1024 -x 512 -a $SMALL_DATASET -d $DURATION -T 8 -R 100 -S 16
	timeout 12s ./bank -n $CPU_THREADS -b 1024 -x 512 -a $SMALL_DATASET -d $DURATION -T 8 -R 100 -S 19
}

function doRunLargeDTST {
	timeout 12s ./bank -n $CPU_THREADS -b 1024 -x 512 -a $LARGE_DATASET -d $DURATION -T 8 -R 100 -S 1
	timeout 12s ./bank -n $CPU_THREADS -b 1024 -x 512 -a $LARGE_DATASET -d $DURATION -T 8 -R 100 -S 2
	timeout 12s ./bank -n $CPU_THREADS -b 1024 -x 512 -a $LARGE_DATASET -d $DURATION -T 8 -R 100 -S 4
	timeout 12s ./bank -n $CPU_THREADS -b 1024 -x 512 -a $LARGE_DATASET -d $DURATION -T 8 -R 100 -S 6
	timeout 12s ./bank -n $CPU_THREADS -b 1024 -x 512 -a $LARGE_DATASET -d $DURATION -T 8 -R 100 -S 8
	timeout 12s ./bank -n $CPU_THREADS -b 1024 -x 512 -a $LARGE_DATASET -d $DURATION -T 8 -R 100 -S 12
	timeout 12s ./bank -n $CPU_THREADS -b 1024 -x 512 -a $LARGE_DATASET -d $DURATION -T 8 -R 100 -S 16
	timeout 12s ./bank -n $CPU_THREADS -b 1024 -x 512 -a $LARGE_DATASET -d $DURATION -T 8 -R 100 -S 19
}
