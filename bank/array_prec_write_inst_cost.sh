...
function doRunLargeDTST {
	...
	do
		...
		timeout 40s ./bank -n 1 -b 20 -x 128 -a $LARGE_DATASET -d $DURATION -R 0 -S 16 -l 10 -N 1 -T 32 CPU_BACKOFF=10
		timeout 40s ./bank -n 1 -b 20 -x 128 -a $LARGE_DATASET -d $DURATION -R 0 -S 16 -l 25 -N 1 -T 32 CPU_BACKOFF=10
		timeout 40s ./bank -n 1 -b 20 -x 128 -a $LARGE_DATASET -d $DURATION -R 0 -S 16 -l 50 -N 1 -T 32 CPU_BACKOFF=10
		timeout 40s ./bank -n 1 -b 20 -x 128 -a $LARGE_DATASET -d $DURATION -R 0 -S 16 -l 75 -N 1 -T 32 CPU_BACKOFF=10
		timeout 40s ./bank -n 1 -b 20 -x 128 -a $LARGE_DATASET -d $DURATION -R 0 -S 16 -l 90 -N 1 -T 32 CPU_BACKOFF=10
		mv Bank.csv ${1}${s}
	done
}
...
# 	BANK_PART=1 GPU_PART=0.55 CPU_PART=0.55 P_INTERSECT=0.00 PROFILE=1 -j 14
# doRunLargeDTST BMAP_rand_sep_STM_s
...
# 	CPU_PART=0.55 P_INTERSECT=0.00 BANK_PART=1 PROFILE=1 -j 14 >/dev/null
...
# make clean ; make CMP_TYPE=COMPRESSED LOG_TYPE=VERS USE_TSX_IMPL=0 PR_MAX_RWSET_SIZE=20 \
# 	BANK_PART=1 GPU_PART=0.55 CPU_PART=0.55 P_INTERSECT=0.00 PROFILE=1 -j 14
# doRunLargeDTST VERS_rand_sep_STM_SMALL_s
#
# make clean ; make CMP_TYPE=COMPRESSED LOG_TYPE=VERS USE_TSX_IMPL=1 PR_MAX_RWSET_SIZE=20 \
# 	BANK_PART=1 GPU_PART=0.55 CPU_PART=0.55 P_INTERSECT=0.00 PROFILE=1 -j 14
...
# make clean ; make CMP_TYPE=COMPRESSED LOG_TYPE=BMAP USE_TSX_IMPL=0 PR_MAX_RWSET_SIZE=20 \
# 	BANK_PART=1 GPU_PART=0.55 CPU_PART=0.55 P_INTERSECT=0.00 PROFILE=1 -j 14
# doRunLargeDTST BMAP_rand_sep_STM_SMALL_s
#
# make clean ; make CMP_TYPE=COMPRESSED LOG_TYPE=BMAP USE_TSX_IMPL=1 PR_MAX_RWSET_SIZE=20 \
# 	BANK_PART=1 GPU_PART=0.55 CPU_PART=0.55 P_INTERSECT=0.00 PROFILE=1 -j 14
...
make clean ; make CMP_TYPE=COMPRESSED USE_TSX_IMPL=1 CPUEn=0 PR_MAX_RWSET_SIZE=20 GPU_PART=0.55 \
	CPU_PART=0.55 P_INTERSECT=0.00 BANK_PART=5 PROFILE=1 -j 14 BANK_INTRA_CONFL=0.0 >/dev/null
...
############### GPU-only
make clean ; make CMP_TYPE=COMPRESSED USE_TSX_IMPL=1 PR_MAX_RWSET_SIZE=20 GPU_PART=0.55 \
	CPU_PART=0.55 P_INTERSECT=0.00 CPUEn=0 BANK_PART=5 PROFILE=1 -j 14 BANK_INTRA_CONFL=0.0 >/dev/null
...
mkdir -p array_prec_inst_cost
mv *_s* array_prec_inst_cost/
