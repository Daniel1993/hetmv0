...
##################################
# GPU-only
make clean ; make CMP_TYPE=DISABLED CPUEn=0 USE_TSX_IMPL=0 P_INTERSECT=0.0 \
...
##################################
# TSX-only
make clean ; make CMP_TYPE=DISABLED GPUEn=0 USE_TSX_IMPL=1 INST_CPU=0 \
	BANK_PART=2 PROFILE=1 BENCH=BANK -j 14 >/dev/null
...
##################################
# TSX --- GPU_INV
make clean ; make CMP_TYPE=COMPRESSED CPU_INV=0 USE_TSX_IMPL=1 BANK_PART=2 \
