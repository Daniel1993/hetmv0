...
function doRunDTST {
	timeout 50s ./memcd -n $CPU_THREADS -l 32 -b 1024 -x 512 -T 1 -a 2048  -d $DURATION -N 5  -S 0 -G $GPU_INPUT -C $CPU_INPUT
	timeout 50s ./memcd -n $CPU_THREADS -l 32 -b 1024 -x 512 -T 1 -a 4096  -d $DURATION -N 5  -S 0 -G $GPU_INPUT -C $CPU_INPUT
	timeout 50s ./memcd -n $CPU_THREADS -l 32 -b 1024 -x 512 -T 1 -a 8192  -d $DURATION -N 5  -S 0 -G $GPU_INPUT -C $CPU_INPUT
	timeout 50s ./memcd -n $CPU_THREADS -l 32 -b 1024 -x 512 -T 1 -a 16384 -d $DURATION -N 5  -S 0 -G $GPU_INPUT -C $CPU_INPUT
	timeout 50s ./memcd -n $CPU_THREADS -l 32 -b 1024 -x 512 -T 1 -a 32768 -d $DURATION -N 5  -S 0 -G $GPU_INPUT -C $CPU_INPUT
	timeout 50s ./memcd -n $CPU_THREADS -l 32 -b 1024 -x 512 -T 1 -a 65536 -d $DURATION -N 5  -S 0 -G $GPU_INPUT -C $CPU_INPUT
}
...
function doRunDTST100 {
	timeout 50s ./memcd -n $CPU_THREADS -l 32 -b 1024 -x 512 -T 1 -a 2048  -d $DURATION -N 5  -S 100 -G $GPU_INPUT -C $CPU_INPUT
	timeout 50s ./memcd -n $CPU_THREADS -l 32 -b 1024 -x 512 -T 1 -a 4096  -d $DURATION -N 5  -S 100 -G $GPU_INPUT -C $CPU_INPUT
	timeout 50s ./memcd -n $CPU_THREADS -l 32 -b 1024 -x 512 -T 1 -a 8192  -d $DURATION -N 5  -S 100 -G $GPU_INPUT -C $CPU_INPUT
	timeout 50s ./memcd -n $CPU_THREADS -l 32 -b 1024 -x 512 -T 1 -a 16384 -d $DURATION -N 5  -S 100 -G $GPU_INPUT -C $CPU_INPUT
	timeout 50s ./memcd -n $CPU_THREADS -l 32 -b 1024 -x 512 -T 1 -a 32768 -d $DURATION -N 5  -S 100 -G $GPU_INPUT -C $CPU_INPUT
	timeout 50s ./memcd -n $CPU_THREADS -l 32 -b 1024 -x 512 -T 1 -a 65536 -d $DURATION -N 5  -S 100 -G $GPU_INPUT -C $CPU_INPUT
}
...
CPU_INPUT="CPU_input_${SIZE_ZIPF}_099_28672.txt"
if [ ! -f ../$GPU_INPUT ]
then
...
if [ ! -f ../$CPU_INPUT ]
then
	java Main $LARGE_DATASET 0.99 28672 > ../$CPU_INPUT
fi
cd ..
