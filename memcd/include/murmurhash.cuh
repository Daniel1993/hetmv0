#ifndef MURMURHASH3_CUH_GUARD
#define MURMURHASH3_CUH_GUARD
//-----------------------------------------------------------------------------
...
__device__ static inline void MurmurHash3_x64_128 ( const void * key, const int len,
