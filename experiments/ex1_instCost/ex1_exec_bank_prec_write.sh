...
############### GPU-only
make clean ; make CMP_TYPE=COMPRESSED USE_TSX_IMPL=1 PR_MAX_RWSET_SIZE=20 GPU_PART=0.9 \
	CPU_PART=0.1 P_INTERSECT=0.00 CPUEn=0 BANK_PART=9 PROFILE=1 -j 14 \
...
# make clean ; make CMP_TYPE=COMPRESSED GPUEn=1 LOG_TYPE=VERS USE_TSX_IMPL=0 PR_MAX_RWSET_SIZE=20 \
# 	BANK_PART=1 GPU_PART=0.8 CPU_PART=0.8 P_INTERSECT=0.30 PROFILE=1 -j 14 \
# 	DEFAULT_BITMAP_GRANULARITY_BITS=13 >/dev/null

# ############## BMAP
# make clean ; make CMP_TYPE=COMPRESSED GPUEn=0 LOG_TYPE=BMAP USE_TSX_IMPL=1 PR_MAX_RWSET_SIZE=20 \
# 	BANK_PART=9 GPU_PART=0.0 CPU_PART=1.0 P_INTERSECT=0.00 PROFILE=1 -j 14 \
# 	DEFAULT_BITMAP_GRANULARITY_BITS=13 >/dev/null
# doRunLargeDTST BMAP_rand_sep_s

# make clean ; make NVCC=/usr/local/cuda/bin/nvcc CMP_TYPE=VERS GPUEn=1 LOG_TYPE=VERS USE_TSX_IMPL=0 PR_MAX_RWSET_SIZE=20 \
# 	BANK_PART=1 GPU_PART=0.8 CPU_PART=0.8 P_INTERSECT=0.30 PROFILE=1 -j 14 \
# 	DEFAULT_BITMAP_GRANULARITY_BITS=13 >/dev/null
# doRunLargeDTST BMAP_rand_sep_STM_s
###########################################################################

mkdir -p data/array_prec_inst_cost
mv *_s* data/array_prec_inst_cost/
